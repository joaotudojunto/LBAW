<div class="row g-0 p-3 mb-2 rounded bg-white align-items-center">
    <div class="col-2 col-xl-1 pe-3">
        <img src="{{ asset('images/defaultavatar.png')}}" alt="Member avatar" class="rounded-circle img-fluid img-responsive" style="width:90px;height:auto;">
    </div>
    <div class="col-6 col-xl-9">
        ...
        <div class="row g-0">
            <h5 class="h5 truncate" id="member-name-search" data-id = {{$member->id}}>{{$member->username}}</h5>
        </div>
    </div>
