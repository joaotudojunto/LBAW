    ...
    <section class="container g-0 mx-auto mt-4 col-lg-7">
        <header class="p-3 p-lg-5 mb-3 bg-white rounded">
            ...
            <div class="row align-items-center">
                <div class="col-12 ">
                    <h5 class="text-center">Reported Accounts and Content by ActiveNews members:</h5>
                </div>
                </div>
            </div>
        </header>
        ...
        <section class="pill-navigation mb-1">
            <ul class="nav nav-pills mb-1 nav-justified bg-white rounded" id="pills-tab" role="tablist">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show tags" id="pills-reported-tags" role="tabpanel"
